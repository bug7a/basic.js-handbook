...
- Stepper object extends Box object.
...
// SHARED VARIABLES:
Stepper.sharedVariable = "sharedVariable";
Stepper.default = {};
Stepper.resetDefault = function() {

	Stepper.default.value = 1;
	Stepper.default.minimumNumber = 1;
	Stepper.default.maximumNumber = 10;

    Stepper.default.width = 150;
    Stepper.default.height = 50;

    Stepper.default.backgroundColor = "transparent";
    Stepper.default.backgroundBorder = 0;
    Stepper.default.backgroundBorderColor = "rgba(0, 0, 0, 0.1)";
    Stepper.default.backgroundRound = 23;

    Stepper.default.buttonWidth = 42;
    Stepper.default.buttonHeight = 42;
    Stepper.default.buttonOuterSpace = 4;
    Stepper.default.buttonColor = "white";
    Stepper.default.buttonBorder = 1;
    Stepper.default.buttonBorderColor = "rgba(0, 0, 0, 0.8)";
    Stepper.default.buttonRound = 23;
    Stepper.default.buttonRightShadow = "-1px 0px 3px rgba(0, 0, 0, 0.0)";
	Stepper.default.buttonLeftShadow = "1px 0px 3px rgba(0, 0, 0, 0.0)";
	Stepper.default.buttonOpacity = 0.9;
	Stepper.default.buttonDisableOpacity = 0.4;

    Stepper.default.iconWidth = 32;
    Stepper.default.iconHeight = 32;
    Stepper.default.iconFileDecrease = "components/ui-stepper/decrease.svg";
    Stepper.default.iconFileIncrease = "components/ui-stepper/increase.svg";
    Stepper.default.textColor = "rgba(0, 0, 0, 0.8)";
	Stepper.default.fontSize = 22;

}
Stepper.resetDefault();

Stepper.create = function(parameters = {}) {
	...
	// Default values.
	box.default = {};
	for (let parameterName in Stepper.default) {
		box.default[parameterName] = (parameters[parameterName] != undefined) ? parameters[parameterName] : Stepper.default[parameterName];
	}
	...
	*/
	...
	box.setValue = function(number) {
		...
		if (number < minimumNumber) {
			...
			console.log("Stepper: setValue() number is changed because too small.");
		}

		if (number > maximumNumber) {
			number = maximumNumber;
			console.log("Stepper: setValue() number is changed because too big.");
		}
